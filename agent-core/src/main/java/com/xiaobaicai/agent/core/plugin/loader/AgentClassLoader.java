package com.xiaobaicai.agent.core.plugin.loader;
...
import com.xiaobaicai.agent.core.boot.AgentPkgNotFoundException;
import com.xiaobaicai.agent.core.boot.AgentPkgPath;
import com.xiaobaicai.agent.core.boot.PluginBootstrap;
...
public class AgentClassLoader extends ClassLoader {
    ...
    public AgentClassLoader(ClassLoader parent) {
        ...
        if (agentDictionary != null) {
            ...
            LOGGER.info(agentDictionary.getAbsolutePath());
